/*
    case 170 : express 모듈 11 - express-session 미들웨어 (p333) 
*/
...
app.get('/biggle', (request, response) => {
    response.send(`Hi biggle! you viewed this page ${request.session.views['/biggle']} times`);
});

app.listen(3000, () => {
    console.log('Server is running port 3000! => GOTO http://localhost:3000/puddle');
});
